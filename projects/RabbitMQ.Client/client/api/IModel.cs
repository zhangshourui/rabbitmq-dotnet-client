...
namespace RabbitMQ.Client
{
    ...
    public interface IModel : IDisposable
    {
        ...
        /// <summary>
        /// Gets the configured consumer processing concurrency. This value determines how many messages
        /// consumers will process in parallel
        /// </summary>
        int ProcessingConcurrency { get; }
